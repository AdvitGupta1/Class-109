...
print("The mean, median and mode of the heights are {}, {} and {} respectively".format(height_mean,height_median,height_mode))
print("The mean, median and mode of the weights are {}, {} and {} respectively".format(weight_mean,weight_median,weight_mode))
